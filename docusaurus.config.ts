...
const config: Config = {
  ...
  organizationName: 'cungchat', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/cungchat/docs-site',
        },
        blog: false,
        // blog: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            // Để các link social của cungchat vào đây
            // {
